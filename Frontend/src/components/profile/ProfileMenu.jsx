...
export default function ProfileMenu({ user }) {
  ...
  return (
    <div className="relative" ref={ref}>
      ...
      {open && (
        <div className="absolute right-0 mt-3 w-56 rounded-2xl bg-white shadow-xl border border-gray-100 overflow-hidden z-50">
          ...
          <ul className="flex flex-col text-sm">
            ...
            <li className="border-t px-4 py-3 text-red-500 hover:bg-red-50 cursor-pointer">
              Cerrar sesión
            </li>
          </ul>
        </div>
